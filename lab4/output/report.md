...
2. **Применение сценария:**
   ...
   где $s'_{CB1}, s'_{CB2}, s'_{Dep}$ - стоимости активов после действия, $\omega_{CB1}, \omega_{CB2}, \omega_{Dep}$ - мультипликаторы сценария.
...
где $\text{cash}_{t+1}$ - касса после выполнения действия на этапе $t$.
